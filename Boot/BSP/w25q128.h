...
/************************ 引脚配置（根据硬件修改） ************************/
#define W25Q128_CS_LOW()    HAL_GPIO_WritePin(W25Q138_CS_GPIO_Port, W25Q138_CS_Pin, GPIO_PIN_RESET)
#define W25Q128_CS_HIGH()   HAL_GPIO_WritePin(W25Q138_CS_GPIO_Port, W25Q138_CS_Pin, GPIO_PIN_SET)
...
/************************ 芯片参数 ************************/
#define W25Q128_PAGE_SIZE       256     // 单页大小 256字节
#define W25Q128_SECTOR_SIZE     4096    // 单扇区 4KB
#define W25Q128_BLOCK_32K       32768   // 32KB块
#define W25Q128_BLOCK_64K       65536   // 64KB块
#define W25Q128_TOTAL_SIZE      16777216// 总容量 16MB
#define W25Q128_JEDEC_ID        0x522118// W25Q128标准ID
